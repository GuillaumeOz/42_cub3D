...
/*   Updated: 2020/05/08 17:27:36 by gozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef CUB3D_KEY_HANDLER_H
# define CUB3D_KEY_HANDLER_H
...
void			respawn_monster(t_game_engine *eng, t_map *map,
					t_player *hero);
bool			comp_type_check(char *str, t_tile *tile);
void			condition_interact(t_game_engine *engine, t_map *map,
					t_player *hero);
void			player_hitbox(t_player *hero, t_vector2 mvt,
					t_map map, int sign);
