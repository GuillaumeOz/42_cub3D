...
/*   Updated: 2020/05/05 14:51:48 by gozsertt         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color					*malloc_color(t_uchar p_r, t_uchar p_g,
							t_uchar p_b, t_uchar p_a);
t_color					create_color(t_uchar p_r, t_uchar p_g,
							t_uchar p_b, t_uchar p_a);
